...
let rec trans_preproc_expression ((kind, body) : mt) : CST.preproc_expression =
  match body with
  | Children v ->
      (match v with
      | Alt (0, v) ->
...
and trans_preproc_argument_list ((kind, body) : mt) : CST.preproc_argument_list =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1; v2] ->
...
let rec trans_preproc_if_in_field_declaration_list ((kind, body) : mt) : CST.preproc_if_in_field_declaration_list =
  match body with
  | Children v ->
      (match v with
...
and trans_abstract_array_declarator ((kind, body) : mt) : CST.abstract_array_declarator =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1; v2; v3; v4] ->
...
let rec trans_type_declarator ((kind, body) : mt) : CST.type_declarator =
  match body with
  | Children v ->
      (match v with
      | Alt (0, v) ->
...
let rec trans_preproc_if ((kind, body) : mt) : CST.preproc_if =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1; v2; v3; v4; v5] ->
...
let parse_input_tree input_tree =
  ...
  trans_translation_unit matched_tree
