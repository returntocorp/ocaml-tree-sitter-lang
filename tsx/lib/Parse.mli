...
(**
    Functions for parsing tsx programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a tsx program from a string into a typed OCaml CST. *)
val string : ?src_file:string -> string -> CST.program

(** Parse a tsx program from a file into a typed OCaml CST. *)
