...
and trans_channel_type ((kind, body) : mt) : CST.channel_type =
  ...
  | Children v ->
      (match v with
      | Alt (0, v) ->
          `Chan_type_chan_choice_simple_type (
            (match v with
            | Seq [v0; v1] ->
                (
                  Run.trans_token (Run.matcher_token v0),
      ...
      | Alt (1, v) ->
          `Chan_type_chan_LTDASH_choice_simple_type (
            (match v with
            | Seq [v0; v1; v2] ->
                (
                  Run.trans_token (Run.matcher_token v0),
      ...
      | Alt (2, v) ->
          `Chan_type_LTDASH_chan_choice_simple_type (
            (match v with
            | Seq [v0; v1; v2] ->
                (
                  Run.trans_token (Run.matcher_token v0),
...
and trans_statement_list ((kind, body) : mt) : CST.statement_list =
  ...
  | Children v ->
      (match v with
      | Alt (0, v) ->
          `Stmt_list_stmt_rep_choice_LF_stmt_opt_choice_LF_opt_empty_labe_stmt (
            (match v with
            | Seq [v0; v1; v2] ->
                (
...
let parse_input_tree input_tree =
  ...
  trans_source_file matched_tree
