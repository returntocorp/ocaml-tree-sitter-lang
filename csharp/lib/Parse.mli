...
(**
    Functions for parsing csharp programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a csharp program from a string into a typed OCaml CST. *)
val string : ?src_file:string -> string -> CST.compilation_unit

(** Parse a csharp program from a file into a typed OCaml CST. *)
val file : string -> CST.compilation_unit
...
val parse_input_tree :
  Tree_sitter_run.Tree_sitter_parsing.t -> CST.compilation_unit
