/*
  Generated by ocaml-tree-sitter for csharp.
*/
...
// OCaml function
CAMLprim value octs_create_parser_csharp(value unit) {
  CAMLparam0();
  CAMLlocal1(v);
  ...
  ts_parser_set_language(parser, tree_sitter_csharp());
  CAMLreturn(v);
};
