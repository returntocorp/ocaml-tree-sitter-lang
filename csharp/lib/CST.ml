...
type interpolation_format_clause = (Token.t (* ":" *) * unit (* blank *))
[@@deriving sexp_of]
...
type literal = [
  ...
  | `Char_lit of (Token.t (* "'" *) * anon_choice_blank * Token.t (* "'" *))
...
and statement = [
  ...
  | `Exp_stmt of (constant_pattern * Token.t (* ";" *))
  | `Fixed_stmt of (
...
type declaration_list = (
    Token.t (* "{" *) * compilation_unit * Token.t (* "}" *)
)

and compilation_unit = declaration list (* zero or more *)
...
type character_literal (* inlined *) = (
    Token.t (* "'" *) * anon_choice_blank * Token.t (* "'" *)
)
[@@deriving sexp_of]
...
type expression_statement (* inlined *) = (
    constant_pattern * Token.t (* ";" *)
)
[@@deriving sexp_of]
