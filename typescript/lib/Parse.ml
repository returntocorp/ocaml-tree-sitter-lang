...
let trans_jsx_identifier_ ((kind, body) : mt) : CST.jsx_identifier_ =
  match body with
  | Children v ->
      (match v with
      | Alt (0, v) ->
...
let trans_identifier_reference ((kind, body) : mt) : CST.identifier_reference =
  match body with
  | Children v ->
      (match v with
      | Alt (0, v) ->
...
let trans_jsx_attribute_name ((kind, body) : mt) : CST.jsx_attribute_name =
  match body with
  | Children v ->
      (match v with
      | Alt (0, v) ->
...
let trans_jsx_element_name ((kind, body) : mt) : CST.jsx_element_name =
  match body with
  | Children v ->
      (match v with
      | Alt (0, v) ->
...
let trans_index_type_query ((kind, body) : mt) : CST.index_type_query =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1] ->
...
let rec trans_export_statement ((kind, body) : mt) : CST.export_statement =
  match body with
  | Children v ->
      (match v with
      | Alt (0, v) ->
          `Choice_expo_choice_STAR_from_clau_choice_auto_semi (
            (match v with
            | Alt (0, v) ->
      ...
      | Alt (2, v) ->
          `Expo_as_name_id_choice_auto_semi (
            (match v with
            | Seq [v0; v1; v2; v3; v4] ->
                (
                  Run.trans_token (Run.matcher_token v0),
...
and trans_abstract_class_declaration ((kind, body) : mt) : CST.abstract_class_declaration =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1; v2; v3; v4; v5] ->
  ...
  | Children v ->
      ...
      | Seq [v0; v1; v2; v3] ->
          (
            ...
            ,
            Run.trans_token (Run.matcher_token v2),
            trans_type_annotation (Run.matcher_token v3)
          )
      | _ -> assert false
      )
  | Leaf _ -> assert false
...
let trans_lhs_expression ((kind, body) : mt) : CST.lhs_expression =
  match body with
  | Children v ->
      (match v with
      | Alt (0, v) ->
...
let trans_jsx_expression ((kind, body) : mt) : CST.jsx_expression =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1; v2] ->
...
let trans_formal_parameter ((kind, body) : mt) : CST.formal_parameter =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1] ->
...
let trans_constructable_expression ((kind, body) : mt) : CST.constructable_expression =
  match body with
  | Children v ->
      (match v with
      | Alt (0, v) ->
...
let trans_destructuring_pattern ((kind, body) : mt) : CST.destructuring_pattern =
  match body with
  | Children v ->
      (match v with
      | Alt (0, v) ->
...
let rec trans_jsx_element ((kind, body) : mt) : CST.jsx_element =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1; v2] ->
...
let trans_jsx_element_ ((kind, body) : mt) : CST.jsx_element_ =
  match body with
  | Children v ->
      (match v with
      | Alt (0, v) ->
...
let trans_jsx_attribute_value ((kind, body) : mt) : CST.jsx_attribute_value =
  match body with
  | Children v ->
      (match v with
      | Alt (0, v) ->
...
let trans_jsx_attribute_ ((kind, body) : mt) : CST.jsx_attribute_ =
  match body with
  | Children v ->
      (match v with
      | Alt (0, v) ->
...
let trans_jsx_child ((kind, body) : mt) : CST.jsx_child =
  match body with
  | Children v ->
      (match v with
      | Alt (0, v) ->
